...
- Active Directory: Monitoramento de atividade Kerberos, políticas de senha fortes, auditoria de permissões e ACLs, o mais importante aqui é a aplicação do princípio do menor privilégio
